...
/* ============================================================
 *  vWipe Turbo — "Obsidian" UI Theme  (v2)
 *  Deep obsidian base · cyan→violet accent · soft neon glow
 * ============================================================ */
static const char *custom_css =
    /* ---- Global surface ---- */
    "window {\n"
    "    background-image: radial-gradient(ellipse at top left, #0e1322 0%, #070912 55%, #05060d 100%);\n"
    ...
    /* ---- Sidebar ---- */
    ".sidebar {\n"
    "    background-image: linear-gradient(to bottom, #0d111d, #090c16);\n"
    "    border-right: 1px solid #18202f;\n"
    "    box-shadow: inset -1px 0 0 rgba(56, 232, 255, 0.04);\n"
    "    padding: 22px 12px;\n"
    "}\n"
    ".sidebar-logo {\n"
    "    font-size: 21px;\n"
    ...
    "    letter-spacing: 1px;\n"
    "    color: #38e8ff;\n"
    "    text-shadow: 0 0 14px rgba(56, 232, 255, 0.55);\n"
    "}\n"
    ".sidebar-subtitle {\n"
    "    font-size: 9px;\n"
    "    font-weight: bold;\n"
    ...
    "}\n"
    ".sidebar-btn:hover {\n"
    "    background-color: rgba(56, 232, 255, 0.08);\n"
    "    color: #d6f7ff;\n"
    "}\n"
    ".sidebar-btn.active {\n"
    "    background-image: linear-gradient(to right, rgba(56,232,255,0.16), rgba(124,77,255,0.04));\n"
    "    color: #ffffff;\n"
    "    border-left: 3px solid #38e8ff;\n"
    "    border-radius: 0px 8px 8px 0px;\n"
    "    box-shadow: 0 0 18px rgba(56, 232, 255, 0.12);\n"
    "}\n"

    /* ---- Page headers ---- */
    ".page-container { padding: 14px 26px; }\n"
    ".page-title {\n"
    "    font-size: 23px;\n"
    "    font-weight: 800;\n"
    ...
    /* ---- Cards ---- */
    ".card {\n"
    "    background-image: linear-gradient(to bottom right, #121829, #0c111d);\n"
    ...
    "    color: #f3f7fc;\n"
    "}\n"
    ".card-subtitle { font-size: 12px; color: #8ea2ba; }\n"
    ".card-icon {\n"
    "    font-size: 21px;\n"
    "    color: #38e8ff;\n"
    "    text-shadow: 0 0 12px rgba(56, 232, 255, 0.45);\n"
    "}\n"

    /* ---- Badges ---- */
    ".badge-success {\n"
    "    background-color: rgba(34, 211, 158, 0.14);\n"
    "    color: #22d39e;\n"
    "    font-weight: bold;\n"
    "    font-size: 11px;\n"
    "    padding: 3px 10px;\n"
    "    border-radius: 999px;\n"
    "    border: 1px solid rgba(34, 211, 158, 0.35);\n"
    "}\n"
    ".badge-warning {\n"
    "    background-color: rgba(251, 178, 53, 0.14);\n"
    "    color: #fbb235;\n"
    "    font-weight: bold;\n"
    "    font-size: 11px;\n"
    "    padding: 3px 10px;\n"
    "    border-radius: 999px;\n"
    "    border: 1px solid rgba(251, 178, 53, 0.35);\n"
    "}\n"

    /* ---- Primary action button ---- */
    ".action-btn {\n"
    "    background-image: linear-gradient(120deg, #38e8ff 0%, #2a8cff 50%, #7c4dff 100%);\n"
    "    color: #06121a;\n"
    "    font-weight: 800;\n"
    ...
    "    border-radius: 10px;\n"
    "    padding: 10px 18px;\n"
    "    box-shadow: 0 6px 18px rgba(42, 140, 255, 0.35),\n"
    "                inset 0 1px 0 rgba(255,255,255,0.30);\n"
    "}\n"
    ".action-btn:hover {\n"
    "    background-image: linear-gradient(120deg, #5cf0ff 0%, #4a9eff 50%, #9168ff 100%);\n"
    "    box-shadow: 0 8px 26px rgba(56, 232, 255, 0.50),\n"
    ...
    ".stop-btn {\n"
    "    background-image: linear-gradient(120deg, #ff5470, #d61f3c);\n"
    "    color: #ffffff;\n"
    "    font-weight: 800;\n"
    "    border: none;\n"
    "    border-radius: 10px;\n"
    "    padding: 10px 18px;\n"
    "    box-shadow: 0 6px 18px rgba(214, 31, 60, 0.35),\n"
    "                inset 0 1px 0 rgba(255,255,255,0.25);\n"
    "}\n"
    ".stop-btn:hover {\n"
    "    background-image: linear-gradient(120deg, #ff7088, #ef2e4b);\n"
    "    box-shadow: 0 8px 26px rgba(255, 84, 112, 0.50);\n"
    "}\n"
    ".stop-btn:disabled {\n"
    "    background-image: none;\n"
    "    background-color: #161d2c;\n"
    ...
    "    background-image: linear-gradient(to right, #38e8ff, #2a8cff, #7c4dff);\n"
    "    border-radius: 999px;\n"
    "    min-height: 12px;\n"
    "    box-shadow: 0 0 14px rgba(56, 232, 255, 0.55);\n"
    "}\n"
    "progressbar text { color: #c7d2e0; font-size: 10px; font-weight: bold; }\n"
    ...
    "    border-radius: 10px;\n"
    "    padding: 10px;\n"
    "    box-shadow: inset 0 0 24px rgba(34, 211, 158, 0.05);\n"
    "}\n"
    ".terminal-log text { background-color: transparent; }\n"

    /* ---- Generic controls ---- */
    "button {\n"
    "    background-image: linear-gradient(to bottom, #1a2334, #131a28);\n"
    ...
    "}\n"
    "button:hover {\n"
    "    background-image: linear-gradient(to bottom, #223047, #19223400);\n"
    "    border-color: #38e8ff;\n"
    ...
    "    border-color: #38e8ff;\n"
    "    box-shadow: 0 0 0 2px rgba(56, 232, 255, 0.18);\n"
    "}\n"
...
static void add_feature_row(GtkWidget *box, const char *title, const char *desc, const char *icon_symbol) {
    ...
    gtk_label_set_markup(GTK_LABEL(title_label), g_strdup_printf("<span weight='bold' size='large' color='#38e8ff'>%s</span>", title));
...
gboolean update_dashboard_stats(gpointer user_data G_GNUC_UNUSED) {
    ...
    if (g_operation_running) {
        ...
        gtk_label_set_markup(GTK_LABEL(lbl_dash_status), "<span color='#38e8ff' weight='bold'>SYSTEM IDLE / SECURE</span>");
    }
...
GtkWidget* create_main_window(void) {
    ...
    gtk_label_set_markup(GTK_LABEL(lbl_dash_status), "<span size='x-large' color='#38e8ff' weight='bold'>SYSTEM IDLE / SECURE</span>");
